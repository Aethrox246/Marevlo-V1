                ...
                <div style={{ marginBottom: '52px', position: 'relative', overflow: 'visible', animation: 'rpFadeUp 0.5s ease both' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <h1 style={{
                            ...
                            background: isDark
                                ? 'linear-gradient(135deg, #ffffff 0%, #f5f5ff 30%, #fbbf24 72%, #f59e0b 100%)'
                            ...
                            return (
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: active ? (tag === 'All' ? '#f59e0b' : c) : 'var(--card)',
                                        color:      active ? (tag === 'All' ? '#000'   : '#fff') : 'var(--muted-foreground)',
                                        border:     active ? `1px solid ${tag === 'All' ? '#f59e0b' : c}` : '1px solid var(--border)',
                                    }}
                                    onMouseEnter={e => {
                                        if (!active) {
                            ...
                            return (
                                <button
                                    ...
                                    style={{
                                        ...
                                        fontWeight: 600, cursor: 'pointer', transition: 'all 0.2s',
                                        background: active ? '#f59e0b' : 'var(--card)',
