                    ...
                    <div key={c.code} className="absolute pointer-events-none select-none"
                        ...
                        <div style={{ animation: reduce ? 'none' : `float ${5 + c.z / 30}s ease-in-out ${c.delay}s infinite` }}>
                            <div className="rounded-lg px-3 py-2 border backdrop-blur-md"
                                style={{ background: 'rgba(15,17,23,0.9)', borderColor: `${c.color}80`, boxShadow: `0 10px 26px rgba(0,0,0,0.5), 0 0 18px ${c.color}33` }}>
                                <div className="font-mono text-xs font-bold leading-none" style={{ color: c.color, textShadow: `0 0 12px ${c.color}66` }}>{c.code}</div>
    ...
    return (
        <section ref={ref} className="py-32 px-4 relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none"
                style={{ background: `radial-gradient(ellipse 70% 50% at 78% 8%, ${isDark ? 'rgba(139,92,246,0.10)' : 'rgba(139,92,246,0.06)'}, transparent)` }} />
                ...
                <div style={reveal(0)}>
                    <div className="rounded-3xl border overflow-hidden relative"
                        style={{
                            ...
                            boxShadow: '0 30px 70px -30px rgba(139,92,246,0.45)',
                        }}>
                        {/* header */}
                        <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
                            <div className="w-10 h-10 rounded-xl flex items-center justify-center relative flex-shrink-0"
                                ...
                                <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2"
                                    style={{ background: '#22c55e', borderColor: '#14161d' }} />
                            </div>
                            ...
                            <span className="text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1"
                                style={{ background: 'rgba(139,92,246,0.18)', color: '#c4b5fd', border: '1px solid rgba(139,92,246,0.4)' }}>
                        ...
                        <div className="p-5 space-y-3" style={{ minHeight: 256 }}>
                            ...
                            <div className="flex gap-2.5 items-start">
                                ...
                                <div className="rounded-2xl rounded-tl-sm px-3.5 py-2.5 text-[13px] max-w-[85%] leading-relaxed"
                                    style={{ background: 'rgba(139,92,246,0.15)', border: '1px solid rgba(139,92,246,0.3)', color: '#ede9fe' }}>
                        ...
                        <div className="px-5 pb-5">
                            <div className="flex items-center gap-2 rounded-full px-4 py-2.5"
                                ...
                                <button className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 cursor-pointer"
                                    style={{ background: 'linear-gradient(135deg,#8b5cf6,#6366f1)' }} aria-label="Send message">
                ...
                <div>
                    <div style={reveal(0.05)}>
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border mb-6"
                            ...
                            <span className="text-xs font-bold tracking-widest uppercase" style={{ color: '#a78bfa' }}>Meet MIRA</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter mb-5 text-foreground leading-[1.05]">
                            An AI tutor that{' '}
                            <span style={{ background: 'linear-gradient(135deg,#8b5cf6 0%,#6366f1 55%,#06b6d4 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                    ...
                    <div className="space-y-3">
                        {MIRA_POINTS.map((point, i) => (
                            <div key={point.title}
                                ...
                                onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 16px 40px -18px rgba(139,92,246,0.4)'; e.currentTarget.style.borderColor = 'rgba(139,92,246,0.4)'; }}
                                ...
                                <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                                    ...
                                    <point.icon className="w-5 h-5" style={{ color: '#a78bfa' }} strokeWidth={2} />
                                </div>
                                <div>
