...
.mv-plan h1{font-weight:900;font-size:clamp(2.5rem,5.5vw,3.75rem);letter-spacing:-.03em;line-height:1.05;margin:0 0 14px;
  background:linear-gradient(135deg,#1e1b4b 0%,#3730a3 35%,#0369a1 65%,#6366f1 100%);
  -webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent}
.dark .mv-plan h1{background:linear-gradient(135deg,#fff 0%,#e0e7ff 35%,#a5f3fc 65%,#818cf8 100%);
...
.mv-plan .toggle .slider{position:absolute;z-index:1;top:5px;bottom:5px;left:5px;width:calc(50% - 5px);
  background:linear-gradient(135deg,#6366f1,#06b6d4);border-radius:999px;box-shadow:0 6px 18px -8px rgba(6,182,212,.55);
...
.mv-plan .badge{position:absolute;top:-12px;left:50%;transform:translateX(-50%);
  background:linear-gradient(135deg,#6366f1,#06b6d4);color:#fff;font-size:11px;font-weight:700;letter-spacing:.06em;
  text-transform:uppercase;padding:5px 13px;border-radius:999px;white-space:nowrap;box-shadow:0 8px 20px -8px rgba(6,182,212,.7)}
...
.mv-plan .pack{position:relative;overflow:hidden;display:grid;grid-template-columns:1.4fr 1fr;border-radius:20px;
  ...
  box-shadow:0 30px 70px -32px rgba(6,182,212,.45),0 12px 32px -22px rgba(0,0,0,.6)}
.mv-plan .pack .pglow{position:absolute;border-radius:50%;filter:blur(72px);pointer-events:none}
.mv-plan .pack .pglow.a{top:-110px;left:-60px;width:300px;height:300px;background:radial-gradient(circle,rgba(99,102,241,.5),transparent 65%)}
.mv-plan .pack .pglow.b{bottom:-130px;right:-50px;width:320px;height:320px;background:radial-gradient(circle,rgba(6,182,212,.42),transparent 65%)}
.mv-plan .pack .left{position:relative;z-index:1;padding:36px 34px}
.mv-plan .pack .kicker{font-size:12px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:#67e8f9}
            ...
            <header className="mv-hero">
                ...
                <div className="mv-hero-inner">
                    <div className="eyebrow reveal" style={{ animationDelay: '.05s' }}>
                        <Tag size={11} style={{ color: '#06b6d4' }} />
                        Plans &amp; Pricing
                    </div>
